...
export class SidebarComponent {
  navItems: NavItem[] = [
    ...
    { label: 'Meus Remédios', icon: 'pill', route: '/remedios' },
    { label: 'Hoje', icon: 'bell', route: '/notificacoes' },
    { label: 'Histórico', icon: 'history', route: '/historico' },
  ];
  iconSvg(name: string): string {
    const icons: Record<string, string> = {
      grid: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/></svg>`,
